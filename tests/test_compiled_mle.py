"""Tests for the compiled single-event MLE solver (hitman.wc.inference.compiled).
...
from hitman.wc.inference.batched import (MLEConfig, PaddedEvents, batched_multistart_mle,
                                      make_padded_nll)
from hitman.wc.inference.compiled import CompiledMLEConfig, make_compiled_mle, _bounds
