...
from hitman.wc.npe import make_npe_batch
from hitman.npe import (ConditionalFlow, DeepSetsEncoder, flow_nll,
...
def _spec_from_offsets(offsets, n_pad):
    from hitman.wc.train.identities import IdentityBatchSpec
