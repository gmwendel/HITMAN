...
from hitman.wc.splinemle import (DEFAULT_KNOTS, SplineMLE, build_event_spec, log_prob_u,
                              logZ_time, make_event_batch, splinemle_loss,
                              step_max_intermediate_gib)
from hitman.wc.splinemle.model import log_expm1_over_x
...
def test_phi_monotone():
    ...
    pmt_pos, pmt_normal = _toy_geometry()
    from hitman.wc.splinemle import DEFAULT_PHI_KNOTS
