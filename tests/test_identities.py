...
from hitman.wc.train.identities import (IdentityBatchSpec, IdentityCfg, composed_score,
                                     make_identity_batch, make_score_identity_loss,
                                     score_identity_penalty)
from hitman.wc.train.resident import DeviceData
...
# ---------------------------------------------------------------------------
from hitman.wc.train.identities import (GmmCfg, StratifiedSpec, gmm_moment_penalty,
                                     make_gmm_loss, make_stratified_batch)
from hitman.wc.train.moments import N_LEAN
...
def test_gmm_detects_tilt_with_estimated_W():
    ...
    from hitman.wc.train.moments import estimate_blocks, lean_vector
