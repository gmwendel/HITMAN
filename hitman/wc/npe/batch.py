...
(``hitman.wc.train.identities`` -- offsets table, pad ``n_pad`` with a float mask, drop
...
from hitman.wc.train.identities import build_identity_spec as build_npe_spec  # noqa: F401
