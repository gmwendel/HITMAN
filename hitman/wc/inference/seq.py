...
:mod:`hitman.wc.inference.batched` (lockstep-vmap many events at once); its single
fully-jitted exportable graph is :mod:`hitman.wc.inference.compiled`.

Companion to :func:`hitman.wc.inference.compiled.make_compiled_mle`. That solver fuses the
...
from hitman.wc.inference.compiled import (C_MM_PER_NS, CompiledMLEConfig, _bounds,
                                       _dir_chart, _earliest_weights, _pca_direction,
                                       _quad_cloud)
from hitman.wc.inference.mle import CHART_SCALE, theta_from_chart
from hitman.wc.nn.features import TIME_SCALE, wrap_direction
