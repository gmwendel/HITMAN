...
the single-core CPU ratpac/Eos deployment use :mod:`hitman.wc.inference.seq` instead
(adaptive per-event work, no lockstep tax); for the exportable one-call graph use
:mod:`hitman.wc.inference.compiled`.
...
from hitman.wc.inference.mle import CHART_SCALE, chart_from_theta, cylinder_seeds, theta_from_chart
from hitman.wc.inference.nuts import box_log_prior
