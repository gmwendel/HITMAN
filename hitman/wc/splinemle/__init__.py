...
dimension. See ``hitman.wc.splinemle.model`` for the design rationale.
"""

from hitman.wc.splinemle.model import (
    C_MM_PER_NS,
    DEFAULT_KNOTS,
    DEFAULT_PHI_KNOTS,
    E_REF_DISP,
...
from hitman.wc.splinemle.loss import batch_terms, event_terms, splinemle_loss
from hitman.wc.splinemle.train import (
    EventSpec,
    FitResult,
    build_event_spec,
    fit_splinemle,
