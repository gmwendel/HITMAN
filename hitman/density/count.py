...
The reusable count model extracted from ``hitman.wc.splinemle.model``. The N objects of an
...
composable :class:`hitman.density.factors.DensityFactor`. ``hitman.wc.splinemle.model`` keeps
